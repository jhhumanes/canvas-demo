package com.josehumaneshumanes.canvasdemo.ui.screen.path_demo
...
fun PathDemoScreen() {
    ...
    baseViewModel.changeTitle(stringResource(id = R.string.path_demo))
    ...
    BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
        ...
        Button(
            ...
            Text(
                text = stringResource(
                    id = if (shouldDrawQuad) R.string.draw_cubic else R.string.draw_quadratic
                )
            )
        }
    }
