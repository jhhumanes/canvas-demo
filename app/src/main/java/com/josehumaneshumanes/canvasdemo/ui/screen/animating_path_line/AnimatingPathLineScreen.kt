package com.josehumaneshumanes.canvasdemo.ui.screen.animating_path_line
...
@Composable
fun AnimatingPathLineScreen() {
    val baseViewModel: BaseViewModel = viewModel()
    baseViewModel.changeTitle(stringResource(id = R.string.animating_path_line))
