package com.josehumaneshumanes.canvasdemo.ui.screen.animating_arrow
...
@Composable
fun AnimatingArrowScreen() {
    val baseViewModel: BaseViewModel = viewModel()
    baseViewModel.changeTitle(stringResource(id = R.string.animating_arrow))
    ...
    android.graphics.PathMeasure().apply {
        ...
        getPosTan(pathPortion.value * length, pos, tan) // punto terminal actual para pintar la punta de flecha
    }
