package com.josehumaneshumanes.canvasdemo.ui.screen.tictactoe
...
fun TictactoeScreen() {
    ...
    baseViewModel.changeTitle(stringResource(id = R.string.tictactoe))
    ...
    Column(
        ...
        winningPlayer?.let {
            Text(
                text = "¡El jugador ${it.symbol} gana!",
                fontSize = 25.sp,
